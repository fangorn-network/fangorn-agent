            ...
            return (
              <div key={f.id}>
                ...
                >
                  ...
                  >
                    <span
                      style={{ color: "var(--color-text-secondary, #8a8a8a)" }}
                    >
                      {fName}
                    </span>
                ...
                {!isPlain &&
                  ...
                  Number(f.pricing.price) > 0 && (
                    ...
                    >
                      <span
                        style={{ color: "var(--color-text-tertiary, #5a5a5a)" }}
                      >
                        price
                      </span>
                      <Pill variant="green">
                        ${Number(f.pricing.price).toFixed(2)} USDC
                      </Pill>
                    </div>
                  )}
              </div>
