...
export const ManifestCard = ({ index, manifestState, isExpanded, onToggle, selectedFileIndex, onFileSelect }: ManifestCardProps) => {
  ...
  const handleChatSubmit = () => {
    ...
    const context = {
      ...
      schema_name: manifestState.schema_name,
      schema_id: manifestState.schema_id,
      version: manifestState.version,
      manifest_cid: manifestState.manifest_cid,
      fileCount: manifestState.manifest?.files?.length || 0,
    };
