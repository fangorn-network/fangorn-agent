...
export default function LibraryView({ onPlay, currentTrack }: LibraryViewProps) {
	...
	const at = library.find((e: any) => e.name === a.name)?.paidAt ?? 0
	const bt = library.find((e: any) => e.name === b.name)?.paidAt ?? 0
	return bt - at
})
