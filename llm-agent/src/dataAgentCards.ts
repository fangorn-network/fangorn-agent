...
class AgentCardBuilder {
  ...
  pushNotifications(enabled = true): this {
    this.card.capabilities = { ...this.card.capabilities, pushNotifications: enabled };
    return this;
  }

  stateTransitionHistory(enabled = true): this {
    this.card.capabilities = { ...this.card.capabilities, stateTransitionHistory: enabled };
    return this;
  }
  ...
  addSkill(
    ...
    const skill: { id: string; name: string; description: string; tags: string[]; examples?: string[] } = {
      id,
      name,
      description,
      tags,
