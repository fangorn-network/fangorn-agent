...
2. Install the [Ollama](https://ollama.com/) docker [image](https://hub.docker.com/r/ollama/ollama)
...
5. [QDrant](https://qdrant.tech/) is used for storing long term memories and the [container](https://hub.docker.com/r/qdrant/qdrant) will need to be available `docker pull qdrant/qdrant`
    - When the QDrant container is running, it can be checked and debugged by accessing `http://localhost:6333/dashboard`
